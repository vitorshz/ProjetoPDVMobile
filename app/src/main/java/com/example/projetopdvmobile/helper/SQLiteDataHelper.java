...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE PEDIDO (NUM_PEDIDO INTEGER PRIMARY KEY AUTOINCREMENT , DATA_CRIACAO DATE," +
                "DATA_ENVIO DATE, ESTADO VARCAR(20), NUM_ENVIO INTEGER,CLIENTE_ID INTEGER REFERENCES CLIENTE(ID))");
    }
