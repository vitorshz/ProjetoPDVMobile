...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE PEDIDO (ID INTEGER PRIMARY KEY AUTOINCREMENT , NUM_PEDIDO INTEGER , DATA_CRIACAO INTEGER," +
                "DATA_ENVIO INTEGER, ESTADO VARCAR(20), NUM_ENVIO INTEGER,CLIENTE_ID INTEGER REFERENCES CLIENTE(ID))");
    }
